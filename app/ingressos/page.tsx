...
export default function MenuGeralIngressos() {
  const menuItems = [
    { titulo: "Adicionar Ingressos", descricao: "Cadastrar novos lotes e preços para eventos", link: "/ingressos/criar", icone: (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v6m3-3H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />) },
