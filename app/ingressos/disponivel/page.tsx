      ...
      <div className="max-w-5xl w-full mx-auto relative z-10">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-slate-100 overflow-hidden">
             ...
             <div className="flex items-center gap-4 relative z-10">
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-teal-50/90 text-sm font-medium leading-none">
                    Verifique o estoque de um evento específico
                  </p>
                </div>
             </div>
          ...
          <div className="p-8 sm:p-10 bg-white">
            ...
            <form onSubmit={handleBuscar} className="flex flex-col md:flex-row gap-4 mb-8 border-b border-slate-100 pb-8">
              ...
              <div className="flex items-end">
                <button 
                  type="submit" 
                  disabled={carregando} 
                  className="w-full md:w-auto px-12 bg-teal-600 text-white font-bold py-4 rounded-2xl shadow-lg shadow-teal-500/20 hover:bg-teal-700 active:scale-[0.98] transition-all disabled:opacity-70"
                >
                  {carregando ? 'Buscando...' : 'Ver Lotes'}
                </button>
              </div>
            </form>
            ...
            {carregando && (
              <div className="flex flex-col items-center justify-center py-12 text-slate-400 animate-in fade-in duration-300">
                ...
                <p className="font-bold text-xs uppercase tracking-widest">Buscando estoques...</p>
              </div>
            )}
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                {ingressos.length === 0 ? (
                  <div className="text-center py-12 bg-slate-50 rounded-3xl border border-slate-100">
                    ...
                    <p className="text-slate-500 font-bold uppercase tracking-widest text-xs">Nenhum ingresso encontrado para este Evento.</p>
                  </div>
                ) : (
                  <div>
                    <div className="flex items-center justify-between mb-6 px-2">
                      <h2 className="text-sm font-black text-slate-800 uppercase tracking-widest">
                        Lotes do Evento #{idEvento}
                      </h2>
                    </div>
            ...
            {!buscou && !carregando && (
              <div className="text-center py-12 text-slate-400">
                <p className="font-bold text-xs uppercase tracking-widest">Aguardando ID do evento...</p>
              </div>
            )}
          </div>
        </div>
